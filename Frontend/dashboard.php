...
$isBarbeiro = strtolower($perfil) === 'barbeiro';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title><?php echo $isBarbeiro ? 'Painel do Barbeiro' : 'Painel do Cliente'; ?> - Borcelle Barbearia</title>
    ...
    <div class="max-w-4xl mx-auto">
        <header class="mb-10 flex flex-col gap-4 rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/30">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <p class="text-sm uppercase tracking-[0.3em] text-[#D4AF37]"><?php echo $isBarbeiro ? '✂️ Painel do Barbeiro' : '👤 Painel do Cliente'; ?></p>
